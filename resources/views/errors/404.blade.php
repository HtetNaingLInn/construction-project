...
<div class="container">
    <div class="card col-md-6 offset-3 mt-5 bg-light">
       ...
       <div class="card-body">
        <h3 style="font-size:100px" class="text-center text-danger">404</h3>
        <p class="text-center text-danger" style="font-size:25px; font-weight:bold"><i class="far fa-hand-point-down text-info"></i>&nbsp;Bad Request</p>
